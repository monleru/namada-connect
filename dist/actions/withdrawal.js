...
export const submitWithdraw = (txTransferArgs) => __awaiter(void 0, void 0, void 0, function* () {
    const { account, chainId, disposableSigningKey, feeAmount, gasLimit, memo, nativeToken, } = txTransferArgs;
    ...
    console.log(signer);
    yield signer.submitWithdraw(transferArgs, txArgs, type);
});
